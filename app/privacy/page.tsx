...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen dark:bg-slate-950 bg-gradient-to-b from-background to-purple-50/20">
      {/* Hero Section */}
      <section className="border-b border-border bg-gradient-to-r from-slate-100/50 via-purple-100/50 to-pink-100/50 dark:from-primary/20 dark:via-secondary/20 dark:to-accent/20 px-4 py-16">
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="space-y-6 max-w-4xl mx-auto">
          ...
          <Card className="border-2 border-border shadow-lg hover:shadow-xl transition-shadow">
            <CardHeader className="bg-gradient-to-r from-purple-100/50 to-pink-100/40 dark:from-primary/10 dark:to-secondary/10 border-b border-purple-200 dark:border-border">
      ...
      {/* Footer Info */}
      <section className="bg-gradient-to-b from-slate-50/50 to-purple-50/30 dark:bg-slate-900/50 border-t border-border px-4 py-12">
