  ...
  return (
    <Card className="w-full max-w-md border-border shadow-lg">
      <CardHeader className="space-y-1 text-center">
        ...
        <CardDescription>
          Join PetCare to connect with trainers and manage your pets
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <button
                ...
                className={cn(
                  'flex flex-col items-center justify-center p-3 border-2 rounded-xl transition-all duration-300',
                  selectedRole === 'owner'
              ...
              >
                ...
                <span className="text-xs font-bold">Pet Owner</span>
              </button>
              <button
                type="button"
            ...
            <p className="text-xs text-muted-foreground text-center">
              {selectedRole === 'owner' && 'Manage your pets and book specialized care services.'}
              {selectedRole === 'caregiver' && 'Provide daily care, walking, and sitting services.'}
              {selectedRole === 'trainer' && 'Offer professional training programs and sessions.'}
            </p>
          </div>
                ...
                {passwordRequirements.map((req, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-center gap-2 text-xs">
                      ...
                      <span
                        className={isMet ? 'text-foreground font-medium' : 'text-muted-foreground'}
                      >
                        {req.label}
                      </span>
                    </div>
