...
const premiumBackgrounds = {
  hero: {
    ...
    gradient: "bg-gradient-to-br from-gray-900 to-gray-800 animate-pulse",
    fallback: "/1.jpg"
  },
  about: {
    type: "image" as const,
  ...
  return (
    <div className={`relative w-full h-full overflow-hidden ${className}`}>
      ...
      <div className="absolute inset-0">
        <div className="floating-orb absolute top-0 left-0 w-96 h-96 bg-primary/20 rounded-full blur-3xl animate-pulse" />
        <div className="floating-orb absolute bottom-0 right-0 w-96 h-96 bg-secondary/20 rounded-full blur-3xl animate-pulse delay-1000" />
        <div className="floating-orb absolute top-1/2 left-1/2 w-64 h-64 bg-accent/15 rounded-full blur-2xl animate-pulse delay-500" />
      </div>
