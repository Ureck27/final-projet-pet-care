  ...
  const onSubmit = async (data: CaregiverApplication) => {
    ...
    try {
      ...
      if (data.petTypes && data.petTypes.length > 0) {
        data.petTypes.forEach(type => formData.append('petTypes[]', type))
      }
      ...
      const profileImageFile = (data as any).profileImageFile
      const idDocumentFile = (data as any).idDocumentFile

      if (profileImageFile instanceof File) {
        formData.append('profileImage', profileImageFile)
      }
      if (idDocumentFile instanceof File) {
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <ImageUpload
                      ...
                      onFileChange={(file) => setValue("profileImageFile" as any, file)}
                  ...
                  <div className="space-y-2">
                    ...
                    <ImageUpload
                      ...
                      onFileChange={(file) => setValue("idDocumentFile" as any, file)}
