...
export default function TermsPage() {
  return (
    <main className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="border-b border-border bg-gradient-to-r from-primary/10 via-primary/5 to-secondary/10 dark:from-primary/20 dark:via-secondary/20 dark:to-accent/20 px-4 py-20">
      ...
      {/* Footer Info */}
      <section className="bg-gradient-to-b from-background to-primary/5 dark:bg-background border-t border-border px-4 py-12">
