          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start lg:items-center">
            ...
            <div className="flex flex-col items-start text-left max-w-2xl">
              ...
              <FadeIn direction="up" delay={0.1}>
                <div ref={heroRef} className="mb-6 space-y-2 leading-tight text-shadow-sm float-element text-white dark:text-orange-300">
                  <SplitText
              ...
              <FadeIn direction="up" delay={0.3} className="w-full">
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                    <Button size="lg" className="h-14 px-8 text-base bg-primary hover:bg-primary/90 text-primary-foreground shadow-soft-lg w-full sm:w-auto transition-smooth border-0" asChild>
                      <Link href="/register">
                        Find Your Caregiver
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                    <Button size="lg" className="h-14 px-8 text-base bg-background text-primary border-2 border-primary hover:bg-primary/5 w-full sm:w-auto transition-smooth shadow-soft-lg" asChild>
      ...
      <section className="px-4 py-20 relative paws-relax-diff">
        ...
        <div className="container mx-auto">
          <FadeIn direction="up" className="mb-16 text-center">
            <Badge variant="outline" className="mb-4 border-primary/30 bg-primary/5 text-primary font-semibold shadow-soft-lg hover:shadow-xl transition-smooth">
                  ...
                  <CardContent className="p-8 md:p-10 relative z-10 flex flex-col flex-1">
                    <div className="mb-8 mt-2">
                      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary/10 group-hover:bg-gradient-to-br group-hover:from-primary group-hover:to-primary/80 group-hover:text-primary-foreground transition-all duration-300 shadow-sm border border-transparent dark:border-primary/20 text-primary">
                        {step.icon && <step.icon className="h-8 w-8 dark:drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)] transition-colors" />}
                      </div>
                    </div>
                    <h3 className="mb-4 text-xl md:text-2xl font-bold text-foreground group-hover:text-primary transition-colors tracking-tight">{step.title}</h3>
                    <p className="text-base text-muted-foreground font-medium leading-relaxed">{step.description}</p>
                  </CardContent>
                </Card>
