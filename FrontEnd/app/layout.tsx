...
import { ClientFloatingAssistant } from '@/components/ui/client-floating-assistant';
import './globals.css';
...
export default function RootLayout({
  ...
  return (
    <html lang="en" data-scroll-behavior="smooth" suppressHydrationWarning>
      <body
        className={`${inter.variable} ${poppins.variable} font-sans antialiased transition-smooth text-shadow-sm`}
      >
