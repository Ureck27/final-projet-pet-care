    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">This pet profile doesn't exist or you don't have access.</p>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex gap-2">
            ...
            {user?.role === 'user' && pet.userId === user.id && (
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <div className="flex items-center gap-4">
            <Badge 
              variant={pet.status === 'accepted' ? 'default' : pet.status === 'rejected' ? 'destructive' : 'secondary'}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{new Date(pet.createdAt || Date.now()).toLocaleDateString()}</p>
                  </div>
                </div>
              </div>
