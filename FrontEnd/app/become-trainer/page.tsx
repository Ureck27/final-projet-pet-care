...
export default function BecomeTrainerPage() {
  ...
  const [certificateImageFiles, setCertificateImageFiles] = useState<(File | null)[]>([])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      certificateImageFiles.forEach((file) => {
        if (file) {
          formDataToSend.append('certificateImage', file)
        }
      })
                    ...
                    <div className="grid gap-4">
                      {certificateImages.map((cert, index) => (
                        <ImageUpload
                          ...
                          onFileChange={(file) => {
                            const newFiles = [...certificateImageFiles]
                            newFiles[index] = file
                            setCertificateImageFiles(newFiles)
                          }}
                      ...
                      {certificateImages.length < 3 && (
                        <Button
                          ...
                          onClick={() => {
                            ...
                            setCertificateImageFiles([...certificateImageFiles, null])
                          }}
                          className="w-full"
                        >
